    ...
    public partial class EasyLevelForm : Form
    {
        ...
        public void RandomPictureAssignment()
        {
            ...
            if (MainMenuForm.age == 1)
            {
                ...
                foreach (Control control in tableLayoutPanel_44.Controls)
                {
        ...
        public void CheckGameResult()
        {
            ...
            if (success)
            {
                ...
                System.IO.StreamWriter scoreWriter = new System.IO.StreamWriter(Application.StartupPath + "\\Files\\Easy Level Scores.txt" , true);
        ...
        public EasyLevelForm()
        {
            ...
            if (MainMenuForm.age == 1)
            {
                ...
                tableLayoutPanel_44.BackgroundImage = Image.FromFile(Application.StartupPath + "\\Wallpapers\\childTableLayoutPanelWallpaper.png");
            }
            else if(MainMenuForm.age == 2)
            {
                BackgroundImage = Image.FromFile(Application.StartupPath + "\\Wallpapers\\teenagerFormWallpaper.jpg");
                tableLayoutPanel_44.BackgroundImage = Image.FromFile(Application.StartupPath + "\\Wallpapers\\teenagerTableLayoutPanelWallpaper.jpg");
            }
            else if(MainMenuForm.age == 3)
            {
                BackgroundImage = Image.FromFile(Application.StartupPath + "\\Wallpapers\\adultFormWallpaper.jpg");
                tableLayoutPanel_44.BackgroundImage = Image.FromFile(Application.StartupPath + "\\Wallpapers\\adultTableLayoutPanelWallpaper.jpg");
            }
            foreach (Control control in tableLayoutPanel_44.Controls)
            {
                PictureBox pictureBox = control as PictureBox;
        ...
        private void pictureBox_Click(object sender, EventArgs e)
        {
            if (timerStatus)
            {
                ...
                var cellPos = GetRowColIndex(tableLayoutPanel_44, tableLayoutPanel_44.PointToClient(Cursor.Position));
